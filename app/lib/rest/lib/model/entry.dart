...
class Entry {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is Entry && other.isFolder == isFolder;
  ...
  @override
  String toString() => 'Entry[isFolder=$isFolder]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Entry[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Entry[$key]" has a null value in JSON.');
        });
        return true;
      }());
